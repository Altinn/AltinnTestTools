...
namespace TokenGenerator.Helpers
{
    static class TokenHelper
    {
        ...
        public static string GetEnterpriseToken(string[] scopes, string org, string orgNo, string supplierOrgNo, uint ttl)
        {
            ...
            */
            ...
            var signingCertificate = CertificateHelper.ApiTokenSigningCertificate;
        ...
        public static string GetPersonalToken(string[] scopes, uint userId, uint partyId, string pid, string authLvl, string consumerOrgNo, string userName, string client_amr, uint ttl)
        {
        /*
        {
          "nameid": "61218",
        ...
        */
        ...
        public static bool TryParseScopes(string input, out string[] scopes)
        {
            scopes = null;
        ...
        public static bool IsValidOrgNo(string orgNo)
        {
        ...
        public static bool IsValidAuthLvl(string authlvl)
        {
            return authlvl == "3" || authlvl == "4";
        }

        public static string Dump(string token)
        {
